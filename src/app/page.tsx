...
const perks = [
  ...
  },
  {
    ...
    Icon: Leaf,
    description:
      "We've pledged 1% of sales to the preservation and restoratin of the natural  environment",
  },
];
const Home = () => {
  return (
    <>
      <MaxWidthWrapper>
        <div className=" py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className=" mt-6  text-lg max-w-prose text-muted-foreground ">
            Welcome to DigitalLock. Every asset on our platform is verified by
      ...
      <section className=" border-t border-r-gray-200 bg-gray-50">
            ...
            {perks.map((perk) => {
              return (
                ...
                >
                  ...
                  <div className=" mt6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6">
